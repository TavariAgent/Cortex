...
def test_basic_arithmetic():
    ...
    print(f"Success: {result_engine._value == '15.0'}")
    ...
    print(f"Success: {result_engine._value == '42.0'}")
    ...
    print(f"Result: {result}")
    print(f"Expected: 1111111110111110.0")
    print(f"Success: {result == 1111111110111110.0}")
